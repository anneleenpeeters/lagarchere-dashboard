...
class __TwigTemplate_3cef08e625b8d151d61c0ee27fef039205633c3c77fd2cb6c71be7aae14dd114 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    ";
        ...
        // line 17
        echo "
    <h1 class=\"h3 mb-3 font-weight-normal\">Welkom!</h1>
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control\" required autofocus placeholder=\"email\">
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" required placeholder=\"wachtwoord\">
    ...
    <a href=\"#\" class=\"reg-link\">Ik heb nog geen account.</a>
</form>
    ";
        // line 41
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 41, $this->source); })()), "user", [], "any", false, false, false, 41)) {
            // line 42
            echo "        <div class=\"mb-3 logout-par\">
...
";
    ...
    {
        return array (  166 => 46,  158 => 43,  155 => 42,  153 => 41,  145 => 35,  139 => 22,  133 => 19,  129 => 17,  123 => 15,  121 => 14,  116 => 11,  106 => 10,  94 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Welkom!</h1>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"form-control\" required autofocus placeholder=\"email\">
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" required placeholder=\"wachtwoord\">
    <input type=\"hidden\" name=\"_csrf_token\"
    ...
    {% if app.user %}
        <div class=\"mb-3 logout-par\">
            You are logged in as {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
        </div>
    {% endif %}
    </div>
{% endblock %}
", "security/login.html.twig", "/Users/Anneleen/Sites/laGarchere/templates/security/login.html.twig");
    }
}
